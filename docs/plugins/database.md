...
| `database_showSchema` | Database/showSchema | Show CREATE TABLE statements for all tables in a database |
...
The `available-databases` context handler is implemented as a generator function:
